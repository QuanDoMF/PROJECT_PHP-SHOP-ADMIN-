                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">
                                        <?php echo number_format($danhthuthang).' đ' ?></font>
                                </font>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;"><?php echo number_format($danhthunam).' đ' ?>
                                    </font>
                                </font>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="?action=nhanvien"><button type="button" class="btn btn-primary">Quản Lý Nhân
                            Viên</button></a>
                    <a href="?action=kh"><button type="button" class="btn btn-secondary">Quản Lý Khách Hàng</button></a>
                    <a href="?action=danhmuc"><button type="button" class="btn btn-success">Quản Lý Danh
                            Mục</button></a>
                    <a href="?action=khuyenmai"><button type="button" class="btn btn-danger">Quản Lý Khuyến
                            Mãi</button></a>
