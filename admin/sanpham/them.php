...
<form class="form-row" method="POST" action="sanpham/xuly.php" enctype="multipart/form-data"
    ...
    <div class="form-group col-2"><label for="masv">Tên Sản Phẩm</label><input type="text" class="form-control"
            name="tensp"></div>
    <div class="form-group col-3"><label>Mã Danh Mục</label> <select name="madm"
    ...
    <div class="form-group col-2"><label>Mã Thương Hiệu</label> <select name="mancc"
            class="form-control browser-default custom-select">
    ...
    <div class="form-group col-2">
        ...
        <input type="text" class="form-control" name="dongia" pattern="[0-9]+" title="Please enter a valid number"
            required>
    </div>
    <div class="form-group col-4"><label>Ảnh Nền</label> <input type="file" class="form-control" name="anhnen"
            required></div>
    <div class="form-group col-4"><label>Ảnh sản phẩm</label> <input type="file" class="form-control" name="anhsp[]"
            multiple required></div>
    <div class="form-group col-8"><label>Mô Tả</label><textarea class="form-control" name="mota" required></textarea>
    </div>
