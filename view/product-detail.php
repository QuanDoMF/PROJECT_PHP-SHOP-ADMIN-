...
$ketqua  = product_detail_image($id);
                    ...
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh1'] ?>" class="img-fluid" alt="Quân Code">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh2'] ?>" class="img-fluid" alt="Quân Code">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh3'] ?>" class="img-fluid" alt="Quân Code">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh4'] ?>" class="img-fluid" alt="Quân Code">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <form class="col-sm-4" action="?view=addtocart" method="post" id="form1">
                ...
                <div class="size-wrap">
                    <div class="block-26 mb-2">
                        ...
                        ?>
                                <div class="box-size">
                                    <input type="radio" class="custom-control-input size-radio" id="<?php echo $maSize; ?>" name="size" value="<?php echo $maSize; ?>" required onclick="updateSelectedSize('<?php echo $maSize; ?>')" <?php echo ($soLuong == 0) ? 'disabled' : ''; ?>>

                                    <label class="custom-control-label" for="<?php echo $maSize; ?>">
                                        <h6><?php echo $maSize; ?></h6>
                                    </label>
                                    <span class="quantity-info" data-size="<?php echo $maSize; ?>" style="display:none;"><?php echo $soLuong; ?></span>
                                </div>
                        <?php
                            }
                        }
                    ...
                    <div class="size-wrap">
                        <div class="block-26 mb-2">
                            ...
                            <?php while ($row = (mysqli_fetch_array($product_detail_color))) { ?>
                                <div class="box-mau">
                                    <input type="radio" class="custom-control-input" id="<?php echo $row['MaMau']; ?>" name="mau" value="<?php echo $row['MaMau']; ?>" required onclick="updateSelectedColor('<?php echo $row['MaMau']; ?>')">
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="text" id="soluong" name="soluong" id="soluong" class="form-control input-number" value="1" min="1">
