                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="email" name="email" class="form-control"
                                    placeholder=" &nbsp; e-mail" required value="<?php echo $kh['Email']?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="cart-detail">
                            ...
                            <ul>
                                <li>
                                    <span><?php echo $_POST['sl'].'  sản phẩm'; ?> </span>
                    ...
                    <div class="col-md-12">
                        <div class="cart-detail">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="radio">
                                        <label><input type="radio" name="optradio" checked> Thanh toán khi nhận
                                            hàng</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="radio">
                                        <label><input type="radio" name="optradio" disabled> Thanh toán online (coming
                                            soom)</label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p><button class="btn btn-primary" type="submit" name="order" form="form_order">Thanh
                                Toán</button></p>
                    </div>
                </div>
            </div>
