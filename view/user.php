                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-review-tab" data-toggle="pill" href="#pills-review"
                                    role="tab" aria-controls="pills-review" aria-expanded="true">Đơn Hàng</a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Enter email" value="<?php echo $kh['Email'] ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Họ và tên</label>
                                            <input type="text" class="form-control" name="ten" placeholder="Họ và tên"
                                                value="<?php echo $kh['TenKH'] ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="dc" placeholder="Địa Chỉ"
                                                value="<?php echo $kh['DiaChi'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <div class="password-input">
                                                <label for="exampleInputEmail1">Mật khẩu</label>
                                                <input type="password" id="password" name="password"
                                                    class="form-control" value="<?php echo $kh['MatKhau'] ?>">
                                            ...
                                            <div class="col-md-12 ">
                                                <center>
                                                    ...
                                                    <button type="submit" name="luu"
                                                        class="btn btn-md btn-dark pull-right" form="login_form"> Lưu
                                                    </button>
                                                </center>
                                            </div>
                                        </div>
                                ...
                                <table class="table align-middle mb-0 bg-white">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="ms-2">
                                                        ...
                                                        <p class=" mb-1">
                                                            <?php echo $row1['SoLuong'].' x '.$product['TenSP']; ?></p>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class=" align-middle"> <?php echo number_format($row['TongTien']);?>
                                            </td>
                                            <td class=" align-middle">
                                                <span
                                                    class="badge badge-success rounded-pill d-inline"><?php echo $row['TinhTrang']; ?></span>
                                            </td>
